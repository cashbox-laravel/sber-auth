...
![Sber Auth Driver](https://preview.dragon-code.pro/cashbox/sber-auth.svg?brand=laravel&preposition=none)
...
## About Sber Auth Driver

The Auth driver generates a signature for requests in the Sber API.
